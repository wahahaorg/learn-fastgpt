import { bi as Rgb, bj as rgbConvert, bk as define, bl as extend, bm as Color, bn as nogamma, bo as hue, b7 as commonjsGlobal, b8 as getDefaultExportFromCjs, g as getAccDescription, s as setAccDescription, o as getDiagramTitle, n as setDiagramTitle, a as getAccTitle, b as setAccTitle, _ as __name, c as getConfig2, d as select, e as configureSvgSize, bp as dayjs2, l as log, k as common_default, j as sanitizeUrl_1, p as clear, x as utils_default } from "../app.kAMR529G.js";
import { b as bisector, t as tickStep, c as continuous, a as copy, l as linear } from "./linear.Dq4OD-yw.js";
...
(function(module, exports) {
  !function(t5, s) {
    ...
    var t5, s, n = 1e3, i = 6e4, e = 36e5, r = 864e5, o = 31536e6, u3 = 2628e6, d = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/, a = /\[([^\]]+)]|YYYY|YY|Y|M{1,2}|D{1,2}|H{1,2}|m{1,2}|s{1,2}|SSS/g, h = { years: o, months: u3, days: r, hours: e, minutes: i, seconds: n, milliseconds: 1, weeks: 6048e5 }, c = function(t6) {
      ...
      return y2.calMilliseconds = function() {
        ...
        var t6 = this.$ms;
        this.$d.years = $(t6 / o), t6 %= o, this.$d.months = $(t6 / u3), t6 %= u3, this.$d.days = $(t6 / r), t6 %= r, this.$d.hours = $(t6 / e), t6 %= e, this.$d.minutes = $(t6 / i), t6 %= i, this.$d.seconds = $(t6 / n), t6 %= n, this.$d.milliseconds = t6;
        ...
        return n2.replace(a, function(t7, s2) {
