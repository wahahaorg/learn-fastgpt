const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/sizeCapture-X5ZJPWSS.D97WKdcf.js","assets/app.kAMR529G.js","assets/chunks/framework.BT7OAQ9U.js","assets/chunks/theme.Cv8wVEIk.js"])))=>i.map(i=>d[i]);
import { V as __vitePreload } from "./framework.BT7OAQ9U.js";
import { c as clear$2 } from "./chunk-RYQCIY6F.Dvqkrvl5.js";
import { am as markers_default, an as clear2, ao as clear, ap as clear$1, l as log, c as getConfig2, ag as insertNode, af as insertCluster, ah as positionNode, at as insertEdge, av as insertEdgeLabel, y as getConfig, as as getSubGraphTitleMargins, aw as edgeLabels, x as utils_default, ax as terminalLabels, _ as __name, ay as markerOffsets } from "../app.kAMR529G.js";
import { G as Graph } from "./graph.8K_sYeRe.js";
import "./map.afHScnjh.js";
...
async function createGraphWithElements(element, data4Layout) {
  ...
  if (globalThis.mermaidCaptureSizes) {
    const { captureNodeSizes } = await __vitePreload(async () => {
      const { captureNodeSizes: captureNodeSizes2 } = await import("./sizeCapture-X5ZJPWSS.D97WKdcf.js");
